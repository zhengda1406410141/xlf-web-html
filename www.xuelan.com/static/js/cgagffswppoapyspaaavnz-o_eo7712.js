...
$(function(){
    var $items = $("#bk1_xn_c_teachersv_44_ul");
    var $out = $(".bk1_xn_c_teachersv_44_main");   
    var $items_child_width = $items.children().outerWidth(true);
    var iLilen=$items.children(".bk1_xn_c_teachersv_44_li").length;
    $items.css('width',$items_child_width*iLilen+'px');
    $("#bk1_xn_c_teachersv_44_left").click(function(){
        nextImg();
    });
    $("#bk1_xn_c_teachersv_44_right").click(function(){
        prevImg();
    });
    function nextImg(){
